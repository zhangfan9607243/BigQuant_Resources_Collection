...
class VPTA(FACT):
    ...
    def alpha_vpta_consecutive_down(self, n):
        sql_str = " AND ".join([f"m_lag(close, {i}) < m_lag(close, {i + 1})" for i in range(1, n)])
        sql_alpha = f"""
        SELECT
            date,
    ...
    def alpha_vpta_k_length(self):
        ...
        FROM data_base
        """
        return self.get_alpha_df(sql_alpha, lag=15)
    ...
    def alpha_vpta_BIAS(self, n1=3, n2=6):
        ...
        FROM data_base
        """
        return self.get_alpha_df(sql_alpha, lag=max([n1,n2])+15)
    ...
    def alpha_vpta_BBI(self, n1=3, n2=6, n3=12, n4=24):
        ...
        FROM data_base
        """
        return self.get_alpha_df(sql_alpha, lag=max([n1,n2,n3,n4])+15)
    ...
    def alpha_vpta_MACD(self, n_long=26, n_short=13, n_signal=9):
        ...
        FROM data1
        """
        return self.get_alpha_df(sql_alpha, lag=max([n_long,n_short,n_signal])+15)
    ...
    def alpha_vpta_PRICEOSC(self, n_short=13, n_long=26):
        ...
        FROM data_base
        """
        return self.get_alpha_df(sql_alpha, lag=max([n_long,n_short])+15)
    ...
    def alpha_vpta_WAD(self):
        ...
        FROM data1
        """
        return self.get_alpha_df(sql_alpha, lag=9999)
    ...
    def alpha_vpta_VMACD(self, n_short=13, n_long=26, n_signal=9):
        ...
        return self.get_alpha_df(sql_alpha, lag=max([n_short, n_long, n_signal])+15)
    ...
    def alpha_vpta_VOSC(self, n_short = 13, n_long=26):
        ...
        FROM data_base
        """
        return self.get_alpha_df(sql_alpha, lag=max([n_short, n_long])+15)
